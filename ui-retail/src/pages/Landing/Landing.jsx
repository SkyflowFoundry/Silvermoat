      ...
      <div style={{ maxWidth: 1200, width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <Paragraph style={{
            ...
            Complete e-commerce solution for product management, order processing, and operational excellence
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                <Paragraph style={{ fontSize: 16, color: 'rgba(0,0,0,0.65)', marginBottom: 24, textAlign: 'center', lineHeight: '1.6' }}>
                  Secure self-service platform for customers to browse products and track orders
                </Paragraph>
                ...
                <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    <ShoppingOutlined style={{ fontSize: 20, color: '#1890ff', marginTop: 2 }} />
                    <div>
                      <Text strong style={{ display: 'block', fontSize: 15 }}>Product Browsing</Text>
                      <Text type="secondary" style={{ fontSize: 14 }}>Browse and search product catalog</Text>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    ...
                    <div>
                      <Text strong style={{ display: 'block', fontSize: 15 }}>Order Tracking</Text>
                      <Text type="secondary" style={{ fontSize: 14 }}>Track orders from cart to delivery</Text>
                    </div>
                  </div>
          ...
          <Col xs={24} sm={24} md={12}>
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                <Paragraph style={{ fontSize: 16, color: 'rgba(0,0,0,0.65)', marginBottom: 24, textAlign: 'center', lineHeight: '1.6' }}>
                  Comprehensive operations hub for retail professionals and administrators
                </Paragraph>
                ...
                <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    ...
                    <div>
                      <Text strong style={{ display: 'block', fontSize: 15 }}>Product Management</Text>
                      <Text type="secondary" style={{ fontSize: 14 }}>Manage products, inventory, and orders</Text>
                    </div>
                  </div>
