...
const ArchitectureViewer = ({ open, onClose }) => {
  return (
    <Modal
      title="About Silvermoat Fintech"
      open={open}
      onCancel={onClose}
      footer={null}
      width="90%"
    ...
    >
      ...
      <div style={{ marginBottom: 48 }}>
        ...
        <Paragraph style={{ fontSize: 15, color: 'rgba(0, 0, 0, 0.65)', marginBottom: 16 }}>
          Silvermoat Fintech is a comprehensive cloud-native fintech management platform built entirely on AWS serverless
          infrastructure. It demonstrates enterprise-grade patterns including Infrastructure as Code (IaC), continuous
          deployment, automated testing, and AI-powered customer support.
        </Paragraph>
        <Paragraph style={{ fontSize: 15, color: 'rgba(0, 0, 0, 0.65)' }}>
          The platform enables fintech organizations to manage the complete customer care lifecycle—from account
          scheduling through customer records, loan management, care coordination, and support—all through an
      ...
      <div style={{ marginBottom: 48 }}>
        ...
        <List
          size="small"
          dataSource={[
            { title: 'Customer Record Management', description: 'Complete EHR with secure access controls' },
            { title: 'Account Scheduling', description: 'Real-time calendar and availability management' },
            { title: 'Loan Management', description: 'Track medications from prescribe to fulfillment' },
            { title: 'Care Coordination', description: 'Multi-provider communication and referrals' },
            { title: 'AI-Powered Support', description: 'Claude AI chatbot for customer and staff assistance' },
            { title: 'HIPAA Compliance', description: 'Secure document storage and audit trails' },
            { title: 'Multi-Role Access', description: 'Separate interfaces for customers and fintech staff' },
          ]}
          renderItem={(item) => (
            <List.Item>
      ...
      <div style={{ marginBottom: 48, textAlign: 'center' }}>
        ...
        <Paragraph style={{ marginBottom: 24, fontSize: 15, color: 'rgba(0, 0, 0, 0.65)' }}>
          Silvermoat Fintech is built on AWS serverless infrastructure with CloudFront CDN for global content delivery,
          API Gateway for REST APIs, four domain-based Lambda handlers, seven DynamoDB tables for data persistence,
          S3 for document storage, and AWS Bedrock integration with Claude AI for intelligent customer support.
        </Paragraph>

        <img
          src="/architecture-fintech.png"
          alt="Silvermoat Fintech AWS Architecture"
          style={{
            width: '100%',
            height: 'auto',
            maxWidth: '1200px',
      ...
      <div style={{ marginBottom: 24, textAlign: 'center' }}>
        ...
        <Paragraph style={{ marginBottom: 24, fontSize: 15, color: 'rgba(0, 0, 0, 0.65)' }}>
          ...
          and fintech systems to process and respond to requests.
        </Paragraph>

        <img
          src="/data-flow-fintech.png"
          alt="Silvermoat Fintech Data Flow"
          style={{
            width: '100%',
            height: 'auto',
            maxWidth: '1200px',
