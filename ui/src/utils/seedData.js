 ...
 * Uses Faker 13.x for high-quality data generation
 */
...
// Business logic constants (not generated by Faker)
...
// Helper functions (exported for reuse in formSampleData.js)
  ...
  try {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const claimData = {
        ...
        adjusterName: faker.person.fullName(),
