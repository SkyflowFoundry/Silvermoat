      ...
      <div style={{ maxWidth: 1200, width: '100%' }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          ...
          <Paragraph style={{
            ...
            Comprehensive healthcare solution for patient records, appointments, and care coordination
            ...
            >
              <div style={{ flex: 1 }}>
                <div style={{
                  ...
                  <MedicineBoxOutlined style={{ fontSize: 40, color: 'white' }} />
                </div>
                ...
                <Paragraph style={{ fontSize: 16, color: 'rgba(0,0,0,0.65)', marginBottom: 24, textAlign: 'center', lineHeight: '1.6' }}>
                  Secure self-service platform for patients to manage appointments and view medical records
                </Paragraph>
                ...
                <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    ...
                    <div>
                      <Text strong style={{ display: 'block', fontSize: 15 }}>Appointment Scheduling</Text>
                      <Text type="secondary" style={{ fontSize: 14 }}>Book and manage appointments online</Text>
                    </div>
                  </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    <MedicineBoxOutlined style={{ fontSize: 20, color: '#1890ff', marginTop: 2 }} />
                    <div>
                      <Text strong style={{ display: 'block', fontSize: 15 }}>Prescription Tracking</Text>
                      <Text type="secondary" style={{ fontSize: 14 }}>View and manage prescriptions</Text>
                    </div>
                  </div>
                </Space>
              </div>
          ...
          <Col xs={24} sm={24} md={12}>
            ...
            >
              <div style={{ flex: 1 }}>
                ...
                <Paragraph style={{ fontSize: 16, color: 'rgba(0,0,0,0.65)', marginBottom: 24, textAlign: 'center', lineHeight: '1.6' }}>
                  Comprehensive operations hub for healthcare professionals and administrators
                </Paragraph>
                ...
                <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    <UserOutlined style={{ fontSize: 20, color: '#52c41a', marginTop: 2 }} />
                    <div>
                      <Text strong style={{ display: 'block', fontSize: 15 }}>Patient Management</Text>
                      <Text type="secondary" style={{ fontSize: 14 }}>Manage patient records and history</Text>
                    </div>
                  </div>

                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    <CalendarOutlined style={{ fontSize: 20, color: '#52c41a', marginTop: 2 }} />
                    <div>
                      <Text strong style={{ display: 'block', fontSize: 15 }}>Appointment Calendar</Text>
                      <Text type="secondary" style={{ fontSize: 14 }}>Schedule and manage appointments</Text>
                    </div>
                  </div>

                  <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                    <TeamOutlined style={{ fontSize: 20, color: '#52c41a', marginTop: 2 }} />
                    <div>
